...
---
**Zitieren**  
Robert Koch-Institut (2023): COVID-19-Impfungen in Deutschland, Berlin: Zenodo. DOI:[10.5281/zenodo.8341556](http://doi.org/10.5281/zenodo.8341556).  
...
Ist die Anzahl an Impfungen einer Impfgruppe mit Impfstoff "Comirnaty-Kleinkinder", "VidPrevtyn Beta" oder "Comirnaty Omicron XBB.1.5" an einem Tag kleiner als eine bestimmte Untergrenze, werden an diesem Tag keine Impfungen für die Impfgruppe ausgewiesen. Um dennoch einen genauen Überblick über die Gesamtzahl der Impfungen zu ermöglichen, werden Impfgruppen mit Impfstoff "Comirnaty-Kleinkinder", "VidPrevtyn Beta" oder "Comirnaty Omicron XBB.1.5" mit weniger als der Untergrenze für die Anzahl an Impfungen zu Impfungen der Folgetage derselben Impfgruppe hinzuaddiert, bis die kumulierte Anzahl der Impfungen an einem Tag den Wert von mindestens der Untergrenze erreicht. Bis zum Impftag 11.09.2023 wird als Untergrenze eine Anzahl von fünf Impfungen und danach von drei Imfpfungen angesetzt.
